    ...
    <footer className="bg-gray-50 border-t border-gray-200 pt-16 pb-8">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              La référence des véhicules électriques pour enfants à Londres. Des répliques haut de gamme
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              {['Garantie 2 ans', 'Service SAV à Londres', 'Véhicules sous licence', 'Norme CE européenne'].map(item => (
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          <p>© {new Date().getFullYear()} Mini Dreams Londres. Tous droits réservés.</p>
